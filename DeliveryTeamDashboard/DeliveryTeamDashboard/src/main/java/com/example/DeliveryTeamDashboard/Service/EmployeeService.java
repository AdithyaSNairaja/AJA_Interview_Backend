...
//       }
	 ...
	 private final EmployeeRepository employeeRepository;
	    ...
	    public Object scheduleInterview(String empId, String interviewType, LocalDate date, LocalTime time, String client, String interviewer, Integer level, String jobDescriptionTitle, String meetingLink) {
	        if ("mock".equalsIgnoreCase(interviewType)) {
	            if (interviewer == null || interviewer.trim().isEmpty()) {
	                throw new IllegalArgumentException("Interviewer is required for mock interviews");
	            }
	            return scheduleMockInterview(empId, date, time, interviewer);
	            ...
	            return scheduleClientInterview(empId, date, time, client, level, jobDescriptionTitle, meetingLink);
	        } else {
	    ...
	    public MockInterview scheduleMockInterview(String empId, LocalDate date, LocalTime time, String interviewer) {
	        ...
	        if (interviewer == null || interviewer.trim().isEmpty()) {
	            throw new IllegalArgumentException("Interviewer name cannot be null or empty");
	        }
	        ...
	        interview.setInterviewer(interviewer.trim());
	        interview.setStatus("scheduled");
	        return mockInterviewRepository.save(interview);
	    }

	    public ClientInterview scheduleClientInterview(String empId, LocalDate date, LocalTime time, String client, Integer level, String jobDescriptionTitle, String meetingLink) {
	        if (empId == null || empId.trim().isEmpty()) {
	            throw new IllegalArgumentException("Employee ID cannot be null or empty");
	        }
	        if (date == null) {
