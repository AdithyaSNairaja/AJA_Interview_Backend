...
//    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**","/api/delivery/mock-interviews/performance","/api/employee/resumes/{resumeId}/download","/api/employee/resumes/employee/{employeeId}/download").permitAll()
                .requestMatchers("/api/employee/**").hasAnyRole("EMPLOYEE", "DELIVERY_TEAM","SALES_TEAM")
                .requestMatchers("/api/delivery/employees").hasAnyRole("EMPLOYEE", "DELIVERY_TEAM","SALES_TEAM")
                .requestMatchers("/api/delivery/interviews/upcoming").hasAnyRole("EMPLOYEE", "DELIVERY_TEAM","SALES_TEAM")
